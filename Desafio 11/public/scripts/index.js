...
window.addEventListener("DOMContentLoaded",async ()=>{
    ...
    document.querySelector("#saludo-bienvenida").textContent=`Bienvenido ${datos.usuario.nombre}`;
    document.querySelector("#btn-desloguear").addEventListener("click",async ()=>{
        await postDatosFetch("/logout");
